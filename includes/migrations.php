...
function upkeepify_get_default_settings() {
    return array(
        ...
        UPKEEPIFY_SETTING_SMTP_PORT => 587,
        ...
        UPKEEPIFY_SETTING_TRUSTEE_REQUIRED_APPROVALS => 1,
        UPKEEPIFY_SETTING_TRUSTEE_REJECT_KILLS       => 1,
        UPKEEPIFY_SETTING_TRUSTEE_REMINDER_COUNT     => 3,
        UPKEEPIFY_SETTING_TRUSTEE_REMINDER_INTERVAL  => 2,
