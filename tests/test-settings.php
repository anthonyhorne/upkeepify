...
class SettingsTest extends TestCase {
	...
	public function test_create_default_pages_creates_frontend_pages_and_saves_urls() {
		...
		$this->assertCount( 5, $GLOBALS['_upkeepify_test_inserted_posts'] );
		...
		$this->assertSame( '[upkeepify_trustee_approval]', $GLOBALS['_upkeepify_test_inserted_posts'][1004]['post_content'] );
		...
		$this->assertSame( 'http://localhost/trustee-approval/', $settings[ UPKEEPIFY_SETTING_TRUSTEE_APPROVAL_PAGE ] );
	}
